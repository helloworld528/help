<template>
  <div>
    ...
    <div style="padding:10px">
      ...
      <el-input style="width:250px;margin-left:40px " suffix-icon="el-icon-search" placeholder="请输入账号搜索"></el-input>
...
<!--    </div>-->
    ...
    <el-table :data="tableData" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="customer_mailbox" label="客户密码" text-align:center width="170">
      </el-table-column>
